...
publishers = [
  ...
  # { name: "Free Malaysia Today", rss_url: "https://www.freemalaysiatoday.com/feed/", default_category: "News", language: "en", bilingual: true },
...
publishers.each_with_index do |pub, ind|
  publisher = Publisher.new(name: pub[:name], rss_url: pub[:rss_url], one_category: pub[:one_category], bilingual: pub[:bilingual])
